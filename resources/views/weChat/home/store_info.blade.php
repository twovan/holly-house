...
@section('body')
    ...
    <div class="page__bd page__bd_footer">
        ...
        <div class="weui-panel">
            <div class="weui-panel__hd">请选择服务</div>
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_small-appmsg">
                    <div class="weui-cells">
                        @foreach($service_lists as $service_list)
                        <a id="{{$service_list->id}}" class="weui-cell weui-cell_access pay" href="{{url('wechat/service',['id' => $service_list->id])}}">
        ...
        <div class="weui-panel">
            ...
            <div class="weui-panel__ft">
                <a href="{{url('wechat/store/evaluate_list',['id' => $list->id])}}" class="weui-cell weui-cell_access weui-cell_link">
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).on("click", '.pay', function () {
            @if(empty($get_user->phone))
                weui.alert('请先绑定手机号');
                //weui.alert(this.id);
                setTimeout("location.href='http://m.heliwu.com.cn/wechat/user/edit_phone?sid="+this.id+"'", 1000);  
                return false;
            @endif
        });
    </script>
